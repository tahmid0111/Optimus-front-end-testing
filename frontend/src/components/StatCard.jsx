...
export default function StatCard({ icon: Icon, label, value, hint, loading, className, style }) {
  return (
    <Card hover className={cn('animate-fade-in p-6', className)} style={style}>
      <div className="flex items-start justify-between">
        ...
        <div className="grid h-12 w-12 place-items-center rounded-2xl bg-blue-tint text-blue">
